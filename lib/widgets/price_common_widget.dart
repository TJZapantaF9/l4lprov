          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text(context.translate.hintPrice,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(context.translate.lblSubTotal,
                            style: secondaryTextStyle(size: 16)),
                        8.width,
                        Text(
                          'P ${price(serviceDetail.price.validate())} * ${bookingDetail.quantity} = P ${(price(serviceDetail.price.validate() * bookingDetail.quantity.validate()))}',
              ...
              if (taxes.isNotEmpty)
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(context.translate.lblTax,
                            style: secondaryTextStyle(size: 16))
                        .expand(),
                    PriceWidget(
                            price: serviceDetail.taxAmount.validate(),
                            color: Colors.red,
                            isBoldText: true,
                            size: 18)
                        .flexible(),
              ...
              if (serviceDetail.discountPrice.validate() != 0 &&
                  serviceDetail.discount.validate() != 0)
                Column(
                  children: [
                    Divider(height: 26),
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(context.translate.hintDiscount,
                                style: secondaryTextStyle(size: 16)),
                            Text(
              ...
              if (couponData != null)
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(context.translate.lblCoupon,
                            style: secondaryTextStyle(size: 16)),
              ...
              Row(
                children: [
                  Text(context.translate.lblTotalAmount,
                          style: secondaryTextStyle(size: 16))
                      .expand(),
                  if (bookingDetail.type == ServiceTypeHourly)
                    Text('(P ${bookingDetail.price}/hr) ',
                        style: secondaryTextStyle()),
                  PriceWidget(
