...
class AuthServices {
  ...
  Future<void> signUpWithEmailPassword(context,
    ...
    if (userCredential.user != null) {
      ...
      String displayName = registerData.first_name.validate() +
          registerData.last_name.validate();
  ...
  Future<void> setRegisterData(BuildContext context,
