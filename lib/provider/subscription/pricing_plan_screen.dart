...
class _PricingPlanScreenState extends State<PricingPlanScreen> {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Scaffold(
        appBar: appBarWidget(context.translate.lblPricingPlan,
          ...
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  42.height,
                  Text(context.translate.lblSelectPlan,
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    data.identifier == FREE
                                        ? 'Free Trial'
                                        : "P ${data.amount.validate().toStringAsFixed(decimalPoint).formatNumberWithComma()}/${data.type.validate()}",
                                    style:
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            8.width,
                                            getPlanStatus(
                                                limitData: data.plan_limitation!
                                                    .featured_service!,
                ...
                child: AppButton(
                  child: Text(
                      selectedPricingPlan!.identifier == FREE
                          ? context.translate.lblProceed.toUpperCase()
                          : context.translate.lblMakePayment.toUpperCase(),
                  ...
                  onTap: () async {
                    if (selectedPricingPlan!.identifier == FREE) {
                      ...
                      await saveSubscription(planRequestModel.toJson())
                        ...
                        appStore.setLoading(false);
                        toast(
                            "${selectedPricingPlan!.title.validate()} is successFully activated");
            ...
            Observer(
                builder: (_) => noDataFound(context).center().visible(
                    !appStore.isLoading &&
                        pricingPlanList.isEmpty &&
                        !hasError)),
            Text(errorSomethingWentWrong, style: secondaryTextStyle())
                .center()
                .visible(hasError),
            Observer(
                builder: (_) =>
